...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fdd6c742206f30015db2dab
...
To start editing your site, you can use the Sanity interface at https://energetic-rabbit-d6c74.sanity.studio/.
...
Generated at `2020-12-19T02:59:21.919Z` by Stackbit version `0.3.40`.